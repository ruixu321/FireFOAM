...
Foam::tmp<Foam::volScalarField>
Foam::radiation::wsggmAbsorptionEmissionSmithBand::ggCoeffCont(const label bandI) const
{
...
void Foam::radiation::wsggmAbsorptionEmissionSmithBand::correctNew // modified to include ggCoeffLambda -> ggCoeff (13/10/2014)
(
...
/*
    ...
    {
        Info<< "Calculating weighting coefficient in band: " << j << endl;
        ggCoeffLambda[j].internalField() = this->ggCoeff(j);
