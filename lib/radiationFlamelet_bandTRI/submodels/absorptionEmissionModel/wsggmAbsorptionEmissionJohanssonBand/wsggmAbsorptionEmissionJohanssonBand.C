...
*/
    ...
    partialPressureH2O=2*partialPressureCO2;	//wMean*(p/101325/dimensionedScalar("unity",dimPressure,1.0))*(Y[indexH2O]/specieThermo[indexH2O].W()); Minh for flamelet
...
Foam::tmp<Foam::volScalarField>
Foam::radiation::wsggmAbsorptionEmissionJohanssonBand::ggCoeffCont(const label bandI) const
{
    ...
    partialPressureCO2=wMean*(p/101325/dimensionedScalar("unity",dimPressure,1.0))*(Y[indexCO2]/specieThermo[indexCO2].W());
    partialPressureH2O=2.0*partialPressureCO2;//wMean*(p/101325/dimensionedScalar("unity",dimPressure,1.0))*(Y[indexH2O]/specieThermo[indexH2O].W()); Minh'modifications for flamelet
...
void Foam::radiation::wsggmAbsorptionEmissionJohanssonBand::correctNew // modified to include ggCoeffLambda -> ggCoeff (13/10/2014)
(
