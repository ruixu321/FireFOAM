...
// WSGGM (Ivan Sikic 10/10/2014)
Foam::tmp<Foam::volScalarField>
Foam::radiation::absorptionEmissionModel::ggCoeff(const label bandI) const
{

    return ggCoeffCont(bandI);
}

// WSGGM (Ivan Sikic 10/10/2014)
Foam::tmp<Foam::volScalarField>
Foam::radiation::absorptionEmissionModel::ggCoeffCont(const label bandI) const
{
...
{
    Info << "absorptionEmissionModel  148" << endl;
...
// WSGGM (Ivan Sikic 10/10/2014)
void Foam::radiation::absorptionEmissionModel::correctNew
(
    volScalarField& ggCoeff,
    PtrList<volScalarField>& ggCoeffj

) const
{

    ggCoeff = this->ggCoeff();
    ggCoeffj[0] = ggCoeff;
